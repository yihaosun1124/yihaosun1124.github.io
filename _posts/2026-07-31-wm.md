...
# I. BC vs. RL for Robot Manipulation

## 1.1 Why BC's Traditional Weaknesses Are Less Decisive Than They Look
...
### 1) Demonstration collection is becoming cheaper
...
### 2) Quadratic error compounding is a worst-case guarantee, not a universal law
...
## 1.3 BC and RL Are Complements, Not Opposites
...
# II. The Challenges of Real-World RL
...
### 1) Real-world experience is costly to scale
...
### 2) Exploration has physical consequences
...
# III. Scaling Robotics RL with World Models
...
## 3.1 Is a Generalist World Model Harder Than a Generalist Policy?
...
## 3.2 A Practical Recipe: Adapt a Foundation Model and Keep Imagination Short
...
![Overview of the VLA-MBPO framework](/assets/img/blogs/wm_blog/vla-mbpo.jpg)
...
## 3.3 Pushing This Recipe to the Limit
...
1. Kumar, A., Fu, Z., Pathak, D., & Malik, J. (2021). [RMA: Rapid Motor Adaptation for Legged Robots](https://arxiv.org/abs/2107.04034).
2. Radosavovic, I., Xiao, T., Zhang, B., Darrell, T., Malik, J., & Sreenath, K. (2023). [Real-World Humanoid Locomotion with Reinforcement Learning](https://arxiv.org/abs/2303.03381).
3. Brohan, A., et al. (2023). [RT-2: Vision-Language-Action Models Transfer Web Knowledge to Robotic Control](https://arxiv.org/abs/2307.15818).
4. Kim, M. J., et al. (2024). [OpenVLA: An Open-Source Vision-Language-Action Model](https://arxiv.org/abs/2406.09246).
5. Octo Model Team. (2024). [Octo: An Open-Source Generalist Robot Policy](https://arxiv.org/abs/2405.12213).
6. Lu, Y., et al. (2022). [AW-Opt: Learning Robotic Skills with Imitation and Reinforcement at Scale](https://proceedings.mlr.press/v164/lu22a.html).
7. Luo, J., et al. (2024). [SERL: A Software Suite for Sample-Efficient Robotic Reinforcement Learning](https://arxiv.org/abs/2401.16013).
8. Chi, C., Xu, Z., Pan, C., Cousineau, E., Burchfiel, B., Feng, S., Tedrake, R., & Song, S. (2024). [Universal Manipulation Interface: In-The-Wild Robot Teaching Without In-The-Wild Robots](https://arxiv.org/abs/2402.10329).
9. Xu, T., Li, Z., & Yu, Y. (2020). [Error Bounds of Imitating Policies and Environments](https://arxiv.org/abs/2010.11876).
10. Foster, D. J., Block, A., & Misra, D. (2024). [Is Behavior Cloning All You Need? Understanding Horizon in Imitation Learning](https://arxiv.org/abs/2407.15007).
11. Zhao, T. Z., Kumar, V., Levine, S., & Finn, C. (2023). [Learning Fine-Grained Bimanual Manipulation with Low-Cost Hardware](https://arxiv.org/abs/2304.13705).
12. Luo, J., Xu, C., Wu, J., & Levine, S. (2024). [Precise and Dexterous Robotic Manipulation via Human-in-the-Loop Reinforcement Learning](https://arxiv.org/abs/2410.21845).
13. Kalashnikov, D., et al. (2018). [QT-Opt: Scalable Deep Reinforcement Learning for Vision-Based Robotic Manipulation](https://arxiv.org/abs/1806.10293).
14. Ankile, L., Simeonov, A., Shenfeld, I., Torne, M., & Agrawal, P. (2024). [From Imitation to Refinement—Residual RL for Precise Assembly](https://arxiv.org/abs/2407.16677).
15. Rajeswaran, A., Kumar, V., Gupta, A., Vezzani, G., Schulman, J., Todorov, E., & Levine, S. (2018). [Learning Complex Dexterous Manipulation with Deep Reinforcement Learning and Demonstrations](https://arxiv.org/abs/1709.10087).
16. Eysenbach, B., Gu, S., Ibarz, J., & Levine, S. (2018). [Leave No Trace: Learning to Reset for Safe and Autonomous Reinforcement Learning](https://arxiv.org/abs/1711.06782).
17. Gupta, A., Yu, J., Zhao, T. Z., Kumar, V., Rovinsky, A., Xu, K., Devlin, T., & Levine, S. (2021). [Reset-Free Reinforcement Learning via Multi-Task Learning: Learning Dexterous Manipulation Behaviors without Human Intervention](https://arxiv.org/abs/2104.11203).
18. Khatri, D., Madaan, L., Tiwari, R., Bansal, R., Duvvuri, S. S., Zaheer, M., Dhillon, I. S., Brandfonbrener, D., & Agarwal, R. (2025). [The Art of Scaling Reinforcement Learning Compute for LLMs](https://arxiv.org/abs/2510.13786).
19. Yu, T., Thomas, G., Yu, L., Ermon, S., Zou, J. Y., Levine, S., Finn, C., & Ma, T. (2020). [MOPO: Model-based Offline Policy Optimization](https://proceedings.neurips.cc/paper_files/paper/2020/hash/a322852ce0df73e204b7e67cbbef0d0a-Abstract.html).
20. Sun, Y., Zhang, J., Jia, C., Lin, H., Ye, J., & Yu, Y. (2023). [Model-Bellman Inconsistency for Model-based Offline Reinforcement Learning](https://proceedings.mlr.press/v202/sun23q.html).
21. NVIDIA, et al. (2025). [World Simulation with Video Foundation Models for Physical AI](https://arxiv.org/abs/2511.00062).
22. Guo, Y., Shi, L. X., Chen, J., & Finn, C. (2025). [Ctrl-World: A Controllable Generative World Model for Robot Manipulation](https://arxiv.org/abs/2510.10125).
23. Wu, J., Yin, S., Feng, N., He, X., Li, D., Hao, J., & Long, M. (2024). [iVideoGPT: Interactive VideoGPTs Are Scalable World Models](https://proceedings.neurips.cc/paper_files/paper/2024/hash/7dbb5bfab324e3b86af9bd0df15498dd-Abstract-Conference.html).
24. Huang, S., Wu, J., Zhou, Q., Miao, S., & Long, M. (2025). [Vid2World: Crafting Video Diffusion Models to Interactive World Models](https://arxiv.org/abs/2505.14357).
25. Zhang, Z., Ren, H., Sun, Y., Sheng, Y., Wang, H., Lin, H., Wu, Z., Bacon, P.-L., & Yu, Y. (2026). [Towards Practical World Model-based Reinforcement Learning for Vision-Language-Action Models](https://arxiv.org/abs/2603.20607).
